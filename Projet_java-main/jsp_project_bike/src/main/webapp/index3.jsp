...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-6 col-xs-10">
      <div class="thumbnail">
        <img src="images/<%= rs.getInt(1) %>.jpg" class="zoom" alt="Image de Vélo" style="width:100%; height:70%">
        ...
        <a class="btn btn-primary" href="editBike.jsp?bikeId=<%= rs.getInt(1) %>">Éditer le vélo</a>
        <a class="btn btn-warning" href="modifyBike.jsp?bikeId=<%= rs.getInt(1) %>">Modifier le vélo</a>
      </div>
